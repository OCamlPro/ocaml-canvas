...
# -*- coding: utf-8 -*-
#
# ocaml-canvas documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ocaml-canvas.tex', 'ocaml-canvas Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ocaml-canvas', 'ocaml-canvas Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ocaml-canvas', 'ocaml-canvas Documentation',
     author, 'ocaml-canvas', 'One line description of project.',
     'Miscellaneous'),
]
