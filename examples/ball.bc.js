...
dt=f,fA="white",f9=10.,am=" ",L="0",f8=-2147483648,cZ="compare: functional value",e0="CapsLock",cY="mkdir",f7="ETOOMANYREFS",bi=1000,gB="ETIMEDOUT",f6="@[",cQ="fs",fz="%u",f5="/static/",eZ=116,fy="ENAMETOOLONG",eY="%i",fx="ESOCKTNOSUPPORT",gA="%ni",an=0xff,fw="EMSGSIZE",eW="black",eX="EISDIR",f4="Assert_failure",f3="2d",cP="canvas",eV="0x",fv=0x7ff0,eU=0xdfff,ft="End_of_file",fu="ELOOP",f1="ENOPROTOOPT",f2="OCAMLRUNPARAM",eT=": closedir failed",gz="Out_of_memory",f0="EPIPE",eR="ECONNRESET",eS="EFBIG",fZ="ENXIO",eQ="Not_found",c3="Failure",fs="EADDRINUSE",a0="Unix.Unix_error",eP="EHOSTUNREACH",fr="^",fY="ENOTTY",bX="ENOTDIR",eO="%Li",fX="EIO",gy="EOVERFLOW",eM="Invalid_argument",eN="ENETDOWN",bT=254,aZ="+",gx=", characters ",$=0xffffff,cX=120,bW="100%",fW=1027,bh=1024,b3="Map.bal",eL="ENOBUFS",fV=246,fp="Pervasives.do_at_exit",fq="ENOTCONN",fo=65536,fU="EFAULT",cT=0xf,bS=", ",eK=512,gv="Match_failure",gw="closedir",eI="%li",eJ=1026,fn=32767,gu=-32,eH="EAGAIN",gt="EMLINK",eG="EPERM",cO="nan",e="",cN="rmdir",eF="EDOM",fm="EDEADLK",cW="Fatal error: exception ",fl="infinity",v="camlinternalFormat.ml",fk="fd ",fT=520.,eE="ENOLCK",eD="Goodbye !\n",c=248,fj="ENOSYS",fS="ESPIPE",gs=0xe0,fi=0xf0,eC="EAFNOSUPPORT",fh="Sys_error",S=0x80,fg=170.,cV="ENOTEMPTY",gr="EDESTADDRREQ",c2="EEXIST",cU=1255,ff=1073741823,fR="ECONNABORTED",eB="EMFILE",gq="ENOMEM",cL=" : flags Open_text and Open_binary are not compatible",cM="Weak.set",b2="px",cS="e",cK=": Not a directory",bV="ENOENT",fQ="Stack_overflow",gp="EBUSY",go=490.,gn="Undefined_recursive_module",gm=2147483647,bg=30.,ag=0x8000,fe=0x800,fN=-48,fO="hidden",fP="ENOTSOCK",eA=" : is a directory",fc="@{",fd="Division_by_zero",ez="ECHILD",aK=".",fa="EOPNOTSUPP",fb="ESRCH",e$="Not_initialized",aB=0x3f,e_="ESHUTDOWN",gl=114,gk="E2BIG",fM="Weak.create",e9=110,fL="EACCES",e7=101,cR=" : file already exists",e8="EPROTOTYPE",aY=128,b1=": No such file or directory",gj="EPFNOSUPPORT",ey="EHOSTDOWN",fK="EINTR",bf=255,fJ="EPROTONOSUPPORT",bR=",",fI="ECONNREFUSED",b0=256,ex="ERANGE",bU=100,cJ="index out of bounds",ah="/",ew="#F0F0F0F0",bQ=252,cI="%d",fH=200.,ev=": file descriptor already closed",aJ="-",eu="EROFS",bP="EBADF",gi=")",e5=200,e6=102,et=15.,e4=-97,gh="Printexc.handle_uncaught_exception",e3="EADDRNOTAVAIL",gg="EALREADY",es=12520,e2="EINVAL",c1=" : flags Open_rdonly and Open_wronly are not compatible",ge="ENETUNREACH",gf="EWOULDBLOCK",gd="EINPROGRESS",fF="Fatal error: exception %s\n",fG="ENOEXEC",gc="ENOSPC",er="ENFILE",bO=250,aL=1000.0,e1="([^/]+)",fE="jsError",bN='"',cH=103,aa=0xffff,bZ=127,eq="f",ep=0xdc00,gb="Sys_blocked_io",fD="ENODEV",eo="EISCONN",fC="src/react.ml",ga="EXDEV",en="buffer.ml",f$="_",fB=104,f_="ENETRESET",c0=1.0,bY="_bigarr02";function
bx(a,b,c){var
...
aq(a,b,c,d,e){if(e==0)return 0;if(d==0&&(e>=c.l||c.t==2&&e>=c.c.length)){c.c=a.t==4?bx(a.c,b,e):b==0&&a.c.length==e?a.c:a.c.substr(b,e);c.t=c.c.length==c.l?0:2}else if(c.t==2&&d==c.c.length){c.c+=a.t==4?bx(a.c,b,e):b==0&&a.c.length==e?a.c:a.c.substr(b,e);c.t=c.c.length==c.l?0:2}else{if(c.t!=4)b8(c);var
...
bo(a){if(a.t==2)a.c+=a4(a.l-a.c.length,"\0");else
...
f=c+1;f<j&&(g=a.charCodeAt(f))<S;f++);if(f-c>eK){d.substr(0,1);k+=d;d=e;k+=a.slice(c,f)}else
d+=a.slice(c,f);if(f==j)break;c=f}b=1;if(++c<j&&((i=a.charCodeAt(c))&-64)==aY){h=i+(g<<6);if(g<gs){b=h-0x3080;if(b<S)b=1}else{b=2;if(++c<j&&((i=a.charCodeAt(c))&-64)==aY){h=i+(h<<6);if(g<fi){b=h-0xe2080;if(b<fe||b>=0xd7ff&&b<0xe000)b=2}else{b=3;if(++c<j&&((i=a.charCodeAt(c))&-64)==aY&&g<0xf5){b=i-0x3c82080+(h<<6);if(b<0x10000||b>0x10ffff)b=3}}}}}if(b<4){c-=b;d+="\ufffd"}else if(b>aa)d+=String.fromCharCode(0xd7c0+(b>>10),ep+(b&0x3FF));else
...
a=this.toString();if(this.t==9)return a;return g2(a)};ao.prototype.slice=function(){var
a=this.t==4?this.c.slice():this.c;return new
ao(this.t,a,this.l)};function
gN(a){return new
ao(0,a,a.length)}function
au(a){return a}function
ar(a){return gN(au(a))}function
b6(a,b,c,d,e){aq(ar(a),b,c,d,e);return 0}function
g4(a){var
...
a=0;a<b.length;a++)if(b[a]=="b"){dq=1;break}else if(b[a].startsWith("b="))dq=+b[a].slice(2);else
continue}}());var
F=[0];function
mI(a,b){if(!a.js_error||b||a[0]==c)a.js_error=new
f.Error("Js exception containing backtrace");return a}function
g(a,b){return dq?mI(a,b):a}function
nl(a,b){throw g([0,a,b])}function
T(a){return a}function
dn(a,b){nl(a,T(b))}function
p(a){dn(F.Invalid_argument,a)}function
mx(){p(cJ)}function
r(a,b,c){c&=an;if(a.t!=4){if(b==a.c.length){a.c+=String.fromCharCode(c);if(b+1==a.l)a.t=0;return 0}b8(a)}a.c[b]=c;return 0}function
a3(a,b,c){if(b>>>0>=a.l)mx();return r(a,b,c)}function
...
nv(a){if(nA)return Math.floor(Math.log2(a));var
...
dp(){dm(F.Division_by_zero)}function
...
c=b.udivmod(a).modulus;if(d&ag)c=c.neg();return c};d.prototype.toInt=function(){return this.lo|this.mi<<24};d.prototype.toFloat=function(){return(this.hi<<16)*Math.pow(2,32)+this.mi*Math.pow(2,24)+this.lo};d.prototype.toArray=function(){return[this.hi>>8,this.hi&an,this.mi>>16,this.mi>>8&an,this.mi&an,this.lo>>16,this.lo>>8&an,this.lo&an]};d.prototype.lo32=function(){return this.lo|(this.mi&an)<<24};d.prototype.hi32=function(){return this.mi>>>8&aa|this.hi<<16};function
br(a,b,c){return new
d(a,b,c)}function
b_(a){if(!isFinite(a)){if(isNaN(a))return br(1,0,fv);return a>0?br(0,0,fv):br(0,0,0xfff0)}var
f=a==0&&1/a==-Infinity?ag:a>=0?0:ag;if(f)a=-a;var
b=nv(a)+1023;if(b<=0){b=0;a/=Math.pow(2,-eJ)}else{a/=Math.pow(2,b-fW);if(a<16){a*=2;b-=1}if(b==0)a/=2}var
d=Math.pow(2,24),c=a|0;a=(a-c)*d;var
e=a|0;a=(a-e)*d;var
g=a|0;c=c&cT|f|b<<4;return br(g,e,c)}function
bu(a){return a.toArray()}function
gM(a,b,c){a.write(32,b.dims.length);a.write(32,b.kind|b.layout<<8);if(b.caml_custom==bY)for(var
...
dh(a){var
f=a.lo,g=a.mi,c=a.hi,d=(c&0x7fff)>>4;if(d==2047)return(f|g|c&cT)==0?c&ag?-Infinity:Infinity:NaN;var
e=Math.pow(2,-24),b=(f*e+g)*e+(c&cT);if(d>0){b+=16;b*=Math.pow(2,d-fW)}else
b*=Math.pow(2,-eJ);if(c&ag)b=-b;return b}function
c8(a){var
d=a.length,c=1;for(var
b=0;b<d;b++){if(a[b]<0)p("Bigarray.create: negative dimension");c=c*a[b]}return c}function
mW(a,b){return new
d(a&$,a>>>24&an|(b&aa)<<8,b>>>16&aa)}function
di(a){return a.hi32()}function
dj(a){return a.lo32()}var
mv=bY;function
aC(a,b,c,d){this.kind=a;this.layout=b;this.dims=c;this.data=d}aC.prototype.caml_custom=mv;aC.prototype.offset=function(a){var
c=0;if(typeof
a==="number")a=[a];if(!(a
instanceof
...
for(var
b=this.dims.length-1;b>=0;b--){if(a[b]<1||a[b]>this.dims[b])bn();c=c*this.dims[b]+(a[b]-1)}return c};aC.prototype.get=function(a){switch(this.kind){case
7:var
d=this.data[a*2+0],b=this.data[a*2+1];return mW(d,b);case
10:case
11:var
e=this.data[a*2+0],c=this.data[a*2+1];return[bT,e,c];default:return this.data[a]}};aC.prototype.set=function(a,b){switch(this.kind){case
...
p("Ml_Bigarray_c_1_1.offset");if(a<0||a>=this.dims[0])bn();return a};a1.prototype.get=function(a){return this.data[a]};a1.prototype.set=function(a,b){this.data[a]=b;return 0};a1.prototype.fill=function(a){this.data.fill(a);return 0};function
gI(a,b,c,d){var
e=gK(a);if(c8(c)*e!=d.length)p("length doesn't match dims");if(b==0&&c.length==1&&e==1)return new
a1(a,b,c,d);return new
aC(a,b,c,d)}function
aF(a){if(!F.Failure)F.Failure=[c,T(c3),-3];dn(F.Failure,a)}function
gJ(a,b,c){var
k=a.read32s();if(k<0||k>16)aF("input_value: wrong number of bigarray dimensions");var
r=a.read32s(),l=r&an,q=r>>8&1,j=[];if(c==bY)for(var
d=0;d<k;d++){var
...
f=c8(j),h=mu(l,f),i=gI(l,q,j,h);switch(l){case
2:for(var
...
d=0;d<f;d++){for(var
e=0;e<8;e++)g[e]=a.read8u();var
m=dh(bs(g));i.set(d,m)}break;case
0:for(var
d=0;d<f;d++){var
m=dg(a.read32s());i.set(d,m)}break;case
10:for(var
d=0;d<f;d++){var
o=dg(a.read32s()),n=dg(a.read32s());i.set(d,[bT,o,n])}break;case
11:var
g=new
Array(8);for(var
d=0;d<f;d++){for(var
...
o=dh(bs(g));for(var
e=0;e<8;e++)g[e]=a.read8u();var
n=dh(bs(g));i.set(d,[bT,o,n])}break}b[0]=(4+k)*4;return gI(l,q,j,h)}function
gH(a,b,c){return a.compare(b,c)}function
cc(a,b){return Math.imul(a,b)}function
G(a,b){b=cc(b,0xcc9e2d51|0);b=b<<15|b>>>32-15;b=cc(b,0x1b873593);a^=b;a=a<<13|a>>>32-13;return(a+(a<<2)|0)+(0xe6546b64|0)|0}function
mR(a,b){a=G(a,dj(b));a=G(a,di(b));return a}function
dd(a,b){return mR(a,b_(b))}function
gL(a){var
...
bq={"_j":{deserialize:m5,serialize:m1,fixed_length:8,compare:mV,hash:mY},"_i":{deserialize:mU,fixed_length:4},"_n":{deserialize:nh,fixed_length:4},"_bigarray":{deserialize:function(a,b){return gJ(a,b,"_bigarray")},serialize:gM,compare:gH,hash:gL},"_bigarr02":{deserialize:function(a,b){return gJ(a,b,bY)},serialize:gM,compare:gH,hash:gL}};function
da(a){return bq[a.caml_custom]&&bq[a.caml_custom].compare}function
gO(a,b,c,d){var
f=da(b);if(f){var
...
ao}function
gP(a){if(typeof
a==="number")return bi;else if(b$(a))return bQ;else if(ca(a))return 1252;else if(a
instanceof
...
instanceof
Number)return bi;else if(a&&a.caml_custom)return cU;else if(a&&a.compare)return 1256;else if(typeof
...
b7(a,b,c){var
f=[];for(;;){if(!(c&&a===b)){var
e=gP(a);if(e==bO){a=a[1];continue}var
g=gP(b);if(g==bO){b=b[1];continue}if(e!==g){if(e==bi){if(g==cU)return gO(a,b,-1,c);return-1}if(g==bi){if(e==cU)return gO(b,a,1,c);return 1}return e<g?-1:1}switch(e){case
247:p(cZ);break;case
248:var
...
1247:p(cZ);break;case
1255:var
i=da(a);if(i!=da(b))return a.caml_custom<b.caml_custom?-1:1;if(!i)p("compare: abstract value");var
...
246:case
254:default:if(gT(e)){p("compare: continuation value");break}if(a.length!=b.length)return a.length<b.length?-1:1;if(a.length>1)f.push(a,b,1);break}}if(f.length==0)return 0;var
h=f.pop();b=f.pop();a=f.pop();if(h+1<a.length)f.push(a,b,h+1);a=a[h];b=b[h]}}function
mH(a,b){return+(b7(a,b,false)==0)}function
mJ(a,b,c,d){if(c>0)if(b==0&&(c>=a.l||a.t==2&&c>=a.c.length))if(d==0){a.c=e;a.t=2}else{a.c=a4(c,String.fromCharCode(d));a.t=c==a.l?0:2}else{if(a.t!=4)b8(a);for(c+=b;b<c;b++)a.c[b]=d}return 0}function
dl(a){a=au(a);var
e=a.length;if(e>31)p("format_int: format too long");var
b={justify:aZ,signstyle:aJ,filler:am,alternate:false,base:0,signedconv:false,width:0,uppercase:false,sign:1,prec:-1,conv:eq};for(var
d=0;d<e;d++){var
...
c=e;if(a.justify==aZ&&a.filler==am)for(var
d=f;d<a.width;d++)c+=am;if(a.signedconv)if(a.sign<0)c+=aJ;else if(a.signstyle!=aJ)c+=a.signstyle;if(a.alternate&&a.base==8)c+=L;if(a.alternate&&a.base==16)c+=a.uppercase?"0X":eV;if(a.justify==aZ&&a.filler==L)for(var
d=f;d<a.width;d++)c+=L;c+=b;if(a.justify==aJ)for(var
d=f;d<a.width;d++)c+=am;return T(c)}function
dc(a,b){function
...
c,f=dl(a),e=f.prec<0?6:f.prec;if(b<0||b==0&&1/b==-Infinity){f.sign=-1;b=-b}if(isNaN(b)){c=cO;f.filler=am}else if(!isFinite(b)){c="inf";f.filler=am}else
...
d=i-1;while(c.charAt(d)==L)d--;if(c.charAt(d)==aK)d--;c=c.slice(0,d+1)+c.slice(i);d=c.length;if(c.charAt(d-3)==cS)c=c.slice(0,d-1)+L+c.slice(d-1);break}else{var
g=e;if(h<0){g-=h+1;c=b.toFixed(g)}else
while(c=b.toFixed(g),c.length>e+1)g--;if(g){var
d=c.length-1;while(c.charAt(d)==L)d--;if(c.charAt(d)==aK)d--;c=c.slice(0,d+1)}}break}return db(f,c)}function
b9(a,b){if(au(a)==cI)return T(e+b);var
c=dl(a);if(b<0)if(c.signedconv){c.sign=-1;b=-b}else
b>>>=0;var
d=b.toString(c.base);if(c.prec>=0){c.filler=am;var
f=c.prec-d.length;if(f>0)d=a4(f,L)+d}return db(c,d)}var
nj=0;function
at(){return nj++}function
cb(a){if(du(a))return a;return g2(a)}function
by(){return typeof
...
d=b[1]||e,g=b[2]||e;return[d,a.substring(d.length+g.length)]}return}return by()&&f.process&&f.process.platform?f.process.platform==="win32"?b:a:a}var
dx=nB();function
g1(a){return a.slice(-1)!==ah?a+ah:a}if(by()&&f.process&&f.process.cwd)var
bp=f.process.cwd().replace(/\\/g,ah);else
var
bp="/static";bp=g1(bp);function
m8(a){a=cb(a);if(!dx(a))a=bp+a;var
e=dx(a),d=e[1].split(ah),b=[];for(var
...
f=d+1;f<h&&(b=a.charCodeAt(f))<S;f++);if(f-d>eK){c.substr(0,1);g+=c;c=e;g+=a.slice(d,f)}else
c+=a.slice(d,f);if(f==h)break;d=f}if(b<fe){c+=String.fromCharCode(0xc0|b>>6);c+=String.fromCharCode(S|b&aB)}else if(b<0xd800||b>=eU)c+=String.fromCharCode(gs|b>>12,S|b>>6&aB,S|b&aB);else if(b>=0xdbff||d+1==h||(i=a.charCodeAt(d+1))<ep||i>eU)c+="\xef\xbf\xbd";else{d++;b=(b<<10)+i-0x35fdc00;c+=String.fromCharCode(fi|b>>18,S|b>>12&aB,S|b>>6&aB,S|b&aB)}if(c.length>bh){c.substr(0,1);g+=c;c=e}}return g+c}function
ay(a){return du(a)?T(a):T(nt(a))}var
nQ=[gk,fL,eH,bP,gp,ez,fm,eF,c2,fU,eS,fK,e2,fX,eX,eB,gt,fy,er,fD,bV,fG,eE,gq,gc,fj,bX,cV,fY,fZ,eG,f0,ex,eu,fS,fb,ga,gf,gd,gg,fP,gr,fw,e8,f1,fJ,fx,fa,gj,eC,fs,e3,eN,ge,f_,fR,eR,eL,eo,fq,e_,f7,gB,fI,ey,eP,fu,gy];function
az(a,b,c,d){var
f=nQ.indexOf(a);if(f<0){if(d==null)d=-9999;f=[0,d]}var
...
h(a){dn(F.Sys_error,a)}function
gZ(a){h(a+b1)}function
ds(a){if(a.t!=4)b8(a);return a.c}function
ac(a){return a.l}function
gD(){}function
I(a){this.data=a}I.prototype=new
gD();I.prototype.constructor=I;I.prototype.truncate=function(a){var
b=this.data;this.data=z(a|0);aq(b,0,this.data,0,a)};I.prototype.length=function(){return ac(this.data)};I.prototype.write=function(a,b,c,d){var
e=this.length();if(a+d>=e){var
f=z(a+d),g=this.data;this.data=f;aq(g,0,this.data,0,e)}aq(c9(b),c,this.data,a,d);return 0};I.prototype.read=function(a,b,c,d){var
e=this.length();if(a+d>=e)d=e-a;if(d){var
f=z(d|0);aq(this.data,a,f,0,d);b.set(ds(f),c)}return d};function
...
I(ar(b[1]))}}};y.prototype.exists=function(a){if(a==e)return 1;var
...
f=c&&aw(a0);if(this.exists(a))if(f)ax(f,az(c2,cY,this.nm(a)));else
h(a+": File exists");var
d=/^(.*)\/[^/]+/.exec(a);d=d&&d[1]||e;if(!this.exists(d))if(f)ax(f,az(bV,cY,this.nm(d)));else
h(d+b1);if(!this.is_dir(d))if(f)ax(f,az(bX,cY,this.nm(d)));else
h(d+cK);this.create_dir_if_needed(this.slash(a))};y.prototype.rmdir=function(a,b){var
c=b&&aw(a0),d=a==e?e:this.slash(a),g=new
RegExp(fr+d+e1);if(!this.exists(a))if(c)ax(c,az(bV,cN,this.nm(a)));else
h(a+b1);if(!this.is_dir(a))if(c)ax(c,az(bX,cN,this.nm(a)));else
h(a+cK);for(var
f
in
this.content)if(f.match(g))if(c)ax(c,az(cV,cN,this.nm(a)));else
h(this.nm(a)+": Directory not empty");delete
this.content[d]};y.prototype.readdir=function(a){var
g=a==e?e:this.slash(a);if(!this.exists(a))h(a+b1);if(!this.is_dir(a))h(a+cK);var
i=new
RegExp(fr+g+e1),d={},c=[];for(var
f
in
this.content){var
b=f.match(i);if(b&&!d[b[1]]){d[b[1]]=true;c.push(b[1])}}return c};y.prototype.opendir=function(a,b){var
c=b&&aw(a0),d=this.readdir(a),e=false,f=0;return{readSync:function(){if(e)if(c)ax(c,az(bP,gw,this.nm(a)));else
h(a+eT);if(f==d.length)return null;var
b=d[f];f++;return{name:b}},closeSync:function(){if(e)if(c)ax(c,az(bP,gw,this.nm(a)));else
...
c;if(b.rdonly&&b.wronly)h(this.nm(a)+c1);if(b.text&&b.binary)h(this.nm(a)+cL);this.lookup(a);if(this.content[a]){if(this.is_dir(a))h(this.nm(a)+eA);if(b.create&&b.excl)h(this.nm(a)+cR);c=this.content[a];if(b.truncate)c.truncate()}else if(b.create){this.create_dir_if_needed(a);this.content[a]=new
...
c;if(this.content[a])h(this.nm(a)+cR);if(b$(b))c=new
I(b);if(ca(b))c=new
I(ar(b));else if(b
instanceof
Array)c=new
I(c9(b));else if(typeof
b==="string")c=new
I(gN(b));else if(b.toString){var
d=ar(ay(b.toString()));c=new
...
ab(a,b){this.fs=require(cQ);this.fd=a;this.flags=b}ab.prototype=new
gD();ab.prototype.constructor=ab;ab.prototype.truncate=function(a){try{this.fs.ftruncateSync(this.fd,a|0)}catch(f){h(f.toString())}};ab.prototype.length=function(){try{return this.fs.fstatSync(this.fd).size}catch(f){h(f.toString())}};ab.prototype.write=function(a,b,c,d){try{if(this.flags.isCharacterDevice)this.fs.writeSync(this.fd,b,c,d);else
...
c=this.fs.readlinkSync(this.nm(a),"utf8");return ay(c)}catch(f){this.raise_nodejs_error(f,b)}};j.prototype.opendir=function(a,b){try{return this.fs.opendirSync(this.nm(a))}catch(f){this.raise_nodejs_error(f,b)}};j.prototype.raise_nodejs_error=function(a,b){var
c=aw(a0);if(b&&c){var
...
gS(a){var
b=dx(a);if(!b)return;return b[0]+ah}var
ce=gS(bp)||aF("unable to compute caml_root"),a6=[];if(by())a6.push({path:ce,device:new
j(ce)});else
a6.push({path:ce,device:new
y(ce)});a6.push({path:f5,device:new
y(f5)});function
g9(a){var
g=m8(a),a=g.join(ah),f=g1(a),c;for(var
e=0;e<a6.length;e++){var
b=a6[e];if(f.search(b.path)==0&&(!c||c.path.length<b.path.length))c={path:b.path,device:b.device,rest:a.substring(b.path.length,a.length)}}if(!c&&by()){var
d=gS(a);if(d&&d.match(/^[a-zA-Z]:\/$/)){var
b={path:d,device:new
j(d)};a6.push(b);c={path:b.path,device:b.device,rest:a.substring(b.path.length,a.length)}}}if(c)return c;h("no device found for "+f)}function
mB(a,b){var
c=g9(a);if(!c.device.register)aF("cannot register file");c.device.register(c.rest,b);return 0}function
g3(a,b){var
a=T(a),b=T(b);return mB(a,b)}function
mL(){var
...
mM(a,b){return+(b7(a,b,false)>=0)}function
de(a,b){var
...
mS(a,b){return de(a,au(b))}function
mP(a,b){var
...
c==="string"?de(a,c):mP(a,c)}function
mQ(a){a^=a>>>16;a=cc(a,0x85ebca6b|0);a^=a>>>13;a=cc(a,0xc2b2ae35|0);a^=a>>>16;return a}function
mN(a,b,c,d){var
j,k,l,h,g,f,e,i,m;h=b;if(h<0||h>b0)h=b0;g=a;f=c;j=[d];k=0;l=1;while(k<l&&g>0){e=j[k++];if(e&&e.caml_custom){if(bq[e.caml_custom]&&bq[e.caml_custom].hash){var
n=bq[e.caml_custom].hash(e);f=G(f,n);g--}}else if(e
instanceof
Array&&e[0]===(e[0]|0))switch(e[0]){case
248:f=G(f,e[2]);g--;break;case
250:j[--k]=e[1];break;default:if(gT(e[0]))break;var
o=e.length-1<<10|e[0];f=G(f,o);for(i=1,m=e.length;i<m;i++){if(l>=h)break;j[l++]=e[i]}break}else if(b$(e)){f=mO(f,e);g--}else if(ca(e)){f=mS(f,e);g--}else if(typeof
e==="string"){f=de(f,e);g--}else if(e===(e|0)){f=G(f,e+e+1);g--}else if(typeof
e==="number"){f=dd(f,e);g--}}f=mQ(f);return f&0x3FFFFFFF}function
mT(a,b,c){if(!isFinite(a)){if(isNaN(a))return ay(cO);return ay(a>0?fl:"-infinity")}var
k=a==0&&1/a==-Infinity?1:a>=0?0:1;if(k)a=-a;var
f=0;if(a==0);else if(a<1)while(a<1&&f>-1022){a*=2;f--}else
while(a>=2){a/=2;f++}var
l=f<0?e:aZ,g=e;if(k)g=aJ;else
switch(c){case
43:g=aZ;break;case
32:g=am;break;default:break}if(b>=0&&b<13){var
i=Math.pow(2,b*4);a=Math.round(a*i)/i}var
d=a.toString(16);if(b>=0){var
j=d.indexOf(aK);if(j<0)d+=aK+a4(b,L);else{var
h=j+1+b;if(d.length<h)d+=a4(h-d.length,L);else
d=d.substr(0,h)}}return ay(g+eV+d+"p"+l+f.toString(10))}function
...
mX(a,b){var
c=dl(a);if(c.signedconv&&mZ(b)){c.sign=-1;b=m2(b)}var
d=e,i=m3(c.base),h="0123456789abcdef";do{var
g=b.udivmod(i);b=g.quotient;d=h.charAt(m4(g.modulus))+d}while(!m0(b));if(c.prec>=0){c.filler=am;var
f=c.prec-d.length;if(f>0)d=a4(f,L)+d}return db(c,d)}function
m7(a,b){return+(b7(a,b,false)<=0)}function
m9(a,b){if(a<0)bn();var
a=a+1|0,c=new
...
f=64-e;if(c<f){a.b8.set(b.subarray(0,c),e);return}a.b8.set(b.subarray(0,f),e);b5(a.w,a.b32);c-=f;d+=f}while(c>=64){a.b8.set(b.subarray(d,d+64),0);b5(a.w,a.b32);c-=64;d+=64}if(c)a.b8.set(b.subarray(d,d+c),0)}function
mq(a){var
c=a.len&aB;a.b8[c]=S;c++;if(c>56){for(var
b=c;b<64;b++)a.b8[b]=0;b5(a.w,a.b32);for(var
b=0;b<56;b++)a.b8[b]=0}else
for(var
b=c;b<56;b++)a.b8[b]=0;a.b32[14]=a.len<<3;a.b32[15]=a.len>>29&0x1FFFFFFF;b5(a.w,a.b32);var
e=new
Uint8Array(16);for(var
d=0;d<4;d++)for(var
b=0;b<4;b++)e[d*4+b]=a.w[d]>>8*b&0xFF;return e}function
np(a){return T(bx(a,0,a.length))}function
m_(a,b,c){var
d=mr(),e=ds(a);ms(d,e.subarray(b,b+c),c);return np(mq(d))}function
m$(a,b,c){return m_(ar(a),b,c)}function
nb(){return 0}var
aG=new
Array();function
gU(a){return aG[a]}function
av(a){var
b=gU(a);if(!b.opened)h("Cannot flush a closed channel");if(!b.buffer||b.buffer_curr==0)return 0;if(b.output)b.output(bx(b.buffer,0,b.buffer_curr));else
...
cf=new
Array(3);function
bj(a,b){I.call(this,z(0));this.log=function(a){return 0};if(a==1&&typeof
...
e=z(d);aq(c9(b),c,e,0,d);this.log(e.toUtf16());return 0}h(this.fd+ev)};bj.prototype.read=function(a,b,c,d){h(this.fd+": file descriptor is write only")};bj.prototype.close=function(){this.log=undefined};function
...
8:d.nonblock=1;break}b=b[2]}if(d.rdonly&&d.wronly)h(au(a)+c1);if(d.text&&d.binary)h(au(a)+cL);var
e=g9(a),f=e.device.open(e.rest,d);return cg(f,undefined)}(function(){function
a(a,b){return by()?nr(a,b):new
bj(a,b)}cg(a(0,{rdonly:1,altname:"/dev/stdin",isCharacterDevice:true}),0);cg(a(1,{buffered:2,wronly:1,isCharacterDevice:true}),1);cg(a(2,{buffered:2,wronly:1,isCharacterDevice:true}),2)}());function
nc(a){var
b=cf[a];if(b.flags.wronly)h(fk+a+" is writeonly");var
...
gV(a){var
b=cf[a];if(b.flags.rdonly)h(fk+a+" is readonly");var
...
nf(a,b,c,d){var
e=gU(a);if(!e.opened)h("Cannot output to a closed channel");b=b.subarray(c,c+d);if(e.buffer_curr+b.length>e.buffer.length){var
g=new
...
ne(a,b,c,d){var
b=ds(b);return nf(a,b,c,d)}function
gW(a,b,c,d){return ne(a,ar(b),c,d)}function
gX(a,b){var
c=T(String.fromCharCode(b));gW(a,c,0,1);return 0}function
ng(a,b){if(b==0)dp();return a%b}function
bv(a,b){return+(b7(a,b,false)!=0)}function
ni(a,b){a[0]=bO;a[1]=b;return 0}function
bw(a){if(a
instanceof
Array&&a[0]==a[0]>>>0)return a[0];else if(b$(a))return bQ;else if(ca(a))return bQ;else if(a
instanceof
Function||typeof
a=="function")return 247;else if(a&&a.caml_custom)return bf;else
return bi}var
c$=aE;function
mw(a){var
c={};if(a)for(var
b=1;b<a.length;b++)c[cb(a[b][1])]=a[b][2];return c}function
V(a,b,c){if(c){var
d=c;if(f.toplevelReloc)a=c$(f.toplevelReloc,[d]);else if(F.symbols){if(!F.symidx)F.symidx=mw(F.symbols);var
e=F.symidx[d];if(e>=0)a=e;else
aF("caml_register_global: cannot locate "+d)}}F[a+1]=b;if(c)F[c]=b}function
cd(a,b){gY[au(a)]=b;return 0}function
nn(){p(cJ)}function
E(a,b){if(b>>>0>=D(a))nn();return a5(a,b)}function
Q(a){a.t&6&&bo(a);return T(a.c)}function
nq(){return 0x7FFFFFFF/4|0}function
nk(){dm(F.Not_found)}function
g0(a){var
b=g4(cb(a));if(b===undefined)nk();return ay(b)}function
...
instanceof
f.Error&&aw(fE))b=[0,aw(fE),a];else
b=[0,F.Failure,ay(String(a))];if(a
instanceof
f.Error)b.js_error=a;return b}}function
nC(a,b,c,d,e,f){a.ctxt.arc(b[1],b[2],c,d,e,f);return 0}function
nD(a){a.ctxt.beginPath();return 0}function
nF(a){a.ctxt.closePath();return 0}function
aO(a){if(a<0)a=Math.ceil(a);return new
d(a&$,Math.floor(a*bt)&$,Math.floor(a*bt*bt)&aa)}var
ap=null,bm=null,bl=null,c7=false;function
c6(){if(c7==false)dm(aw(e$))}var
a2=null;function
dw(){c6();bm=null;if(bl!==null){var
f=bl;a2=null;bl=null;throw f}else if(a2!==null)try{a2();a2=null}catch(f){a2=null;throw f}return 0}function
aD(a){if(bm===null)return false;try{bm(a);return true}catch(f){bl=f;dw();return false}}function
c5(a){return{scaleX:a.target.canvas.width/a.target.clientWidth,scaleY:a.target.canvas.height/a.target.clientHeight}}var
...
mo(a){if(a.target!==null){ap=a.target.canvas;a.target.canvas.target.insertBefore(a.target.canvas.frame,null);var
b=c5(a),c=[aM.BUTTON_ACTION,[0,a.target.canvas,aO(a.timeStamp*aL),[0,a.offsetX*b.scaleX,a.offsetY*b.scaleY],a.button+1,1]];aD(c)}return false}var
O={moving:false,target:null,prev_x:0,prev_y:0};function
mp(a){O.moving=false;if(a.target.canvas!==undefined){var
b=c5(a),c=[aM.BUTTON_ACTION,[0,a.target.canvas,aO(a.timeStamp*aL),[0,a.offsetX*b.scaleX,a.offsetY*b.scaleY],a.button+1,0]];aD(c)}return false}function
mk(a){if(O.moving){var
c=a.pageX,d=a.pageY,f=c-O.prev_x,g=d-O.prev_y;O.prev_x=c;O.prev_y=d;var
b=O.target.canvas;b.x+=f;b.y+=g;O.target.style.left=b.x+b2;O.target.style.top=b.y+b2}else if(a.target.canvas!==undefined){var
e=c5(a),h=[aM.MOUSE_MOVE,[0,a.target.canvas,aO(a.timeStamp*aL),[0,a.offsetX*e.scaleX,a.offsetY*e.scaleY]]];aD(h)}return false}function
mi(a,b,c,d,e){var
g=a.width,f=a.getContext(f3);f.fillStyle="#585858";f.fillRect(0,0,g,30);if(e!==null){f.fillStyle=ew;f.font="bold 16px Arial";f.textAlign="center";f.fillText(cb(e),g/2,21)}f.strokeStyle=ew;f.lineWidth=2.0;if(d==true){f.beginPath();f.moveTo(g-20,10);f.lineTo(g-10,20);f.moveTo(g-20,20);f.lineTo(g-10,10);f.stroke()}}function
bk(a,b){return typeof
a=="object"?a[1]!==0:b}function
c4(a,b){return typeof
a=="object"?a[1]:b}function
mj(a,b){return 0<a&&a<=fn&&0<b&&b<=fn}function
...
nJ(a){if(a.frame!==null){if(ap===a)ap=null;a.frame.style.visibility=fO}return 0}function
...
instanceof
ao)b+=bN+d.toString()+bN;else if(typeof
d=="string")b+=bN+d.toString()+bN;else
b+=f$}b+=gi}else if(a[0]==c)b+=a[1];return b}function
gQ(a){if(a
instanceof
Array&&(a[0]==0||a[0]==c)){var
d=aw(gh);if(d)c$(d,[a,false]);else{var
e=mK(a),b=aw(fp);if(b)c$(b,[0]);console.error(cW+e);if(a.js_error)throw a.js_error}}else
throw a}function
nm(){var
c=f.process;if(c&&c.on)c.on("uncaughtException",function(a,b){gQ(a);c.exit(2)});else if(f.addEventListener)f.addEventListener("error",function(a){if(a.error)gQ(a.error)})}nm();function
m(a,b){return(a.l>=0?a.l:a.l=a.length)==1?a(b):aE(a,[b])}function
K(a,b,c){return(a.l>=0?a.l:a.l=a.length)==2?a(b,c):aE(a,[b,c])}function
mc(a,b,c,d){return(a.l>=0?a.l:a.l=a.length)==3?a(b,c,d):aE(a,[b,c,d])}function
cG(a,b,c,d,e,f){return(a.l>=0?a.l:a.l=a.length)==5?a(b,c,d,e,f):aE(a,[b,c,d,e,f])}function
mb(a,b,c,d,e,f,g,h){return(a.l>=0?a.l:a.l=a.length)==7?a(b,c,d,e,f,g,h):aE(a,[b,c,d,e,f,g,h])}var
nR=undefined;mL();var
ch=[c,gz,-1],dC=[c,fh,-2],dz=[c,c3,-3],dy=[c,eM,-4],a7=[c,eQ,-7],dA=[c,gv,-8],dB=[c,fQ,-9],o=[c,f4,-11],dD=[c,gn,-12],ma=[4,0,0,0,[12,45,[4,0,0,0,0]]],co=[0,[11,'File "',[2,0,[11,'", line ',[4,0,0,0,[11,gx,[4,0,0,0,[12,45,[4,0,0,0,[11,": ",[2,0,0]]]]]]]]]],'File "%s", line %d, characters %d-%d: %s'],cv="step already executed";V(11,dD,gn);V(10,o,f4);V(9,[c,gb,-10],gb);V(8,dB,fQ);V(7,dA,gv);V(6,a7,eQ);V(5,[c,fd,-6],fd);V(4,[c,ft,-5],ft);V(3,dy,eM);V(2,dz,c3);V(1,dC,fh);V(0,ch,gz);function
q(a){if(typeof
...
w(a){throw g([0,dy,a],1)}var
aP=[c,"Stdlib.Exit",at(0)];function
dE(a,b){return m7(a,b)?a:b}function
dF(a,b){return mM(a,b)?a:b}function
bz(a){return 0<=a?a:-a|0}var
bA=f8,g$="true",ha="false";nc(0);var
hb=gV(1),W=gV(2);function
a8(a,b){gW(a,b,0,D(b));return}function
dG(a){a8(W,a);gX(W,10);return av(W)}function
ci(a){var
b=nd(0);for(;;){if(!b)return 0;var
d=b[2],e=b[1];try{av(e)}catch(f){var
c=ai(f);if(c[1]!==dC)throw g(c,0)}b=d}}cd(fp,ci);var
cj=nq(0),a9=(4*cj|0)-1|0,hd=[c,"CamlinternalLazy.Undefined",at(0)];function
bB(a,b){var
...
dK(a,b,c){a:{if(0<=b&&0<=c&&(ac(a)-c|0)>=b){var
d=z(c);aq(a,b,d,0,c);var
e=d;break a}var
e=w(ho)}return Q(e)}function
dL(a,b,c,d,e){if(0<=e&&0<=b&&(ac(a)-e|0)>=b&&0<=d&&(ac(c)-e|0)>=d){aq(a,b,c,d,e);return}return w(hp)}function
aj(a,b,c,d,e){if(0<=e&&0<=b&&(D(a)-e|0)>=b&&0<=d&&(ac(c)-e|0)>=d){b6(a,b,c,d,e);return}return w(hq)}function
dM(a,b){var
d=ac(b);if(0===d)return b;var
e=z(d),f=d-1|0,g=0;if(f>=0){var
c=g;for(;;){r(e,c,m(a,c_(b,c)));var
h=c+1|0;if(f===c)break;c=h}}return e}var
hy=[0,en,94,2],hz=[0,en,93,2],hA="Buffer.add: cannot grow buffer";function
dQ(a,b){var
d=a[2],c=[0,a[3]];for(;;){if(c[1]>=(d+b|0))break;c[1]=2*c[1]|0}if(a9<c[1]){if((d+b|0)>a9)throw g([0,dz,hA],1);c[1]=a9}var
e=z(c[1]);dL(a[1],0,e,0,a[2]);a[1]=e;a[3]=c[1];if((a[2]+b|0)>a[3])throw g([0,o,hz],1);if((d+b|0)<=a[3])return;throw g([0,o,hy],1)}function
a_(a,b){var
c=D(b),d=a[2]+c|0;if(a[3]<d)dQ(a,c);b6(b,0,a[1],a[2],c);a[2]=d;return}var
hB="@]",hC="@}",hD="@?",hE="@\n",hF="@.",hG="@@",hH="@%",hI="%c",hJ="%s",hK=eY,hL=eI,hM=gA,hN=eO,hO="%f",hP="%B",hQ="%{",hR="%}",hS="%(",hT="%)",hU="%a",hV="%t",hW="%?",hX="%r",hY="%_r",hZ=[0,v,850,23],h0=[0,v,837,26],h1=[0,v,847,28],h2=[0,v,815,21],h3=[0,v,819,21],h4=[0,v,823,19],h5=[0,v,827,22],h6=[0,v,832,30],h7=[0,v,851,23],h8=[0,v,836,26],h9=[0,v,846,28],h_=[0,v,814,21],h$=[0,v,818,21],ia=[0,v,822,19],ib=[0,v,826,22],ic=[0,v,831,30];function
cl(a){return 5===a[2]?12:-6}function
dR(a){return[0,0,z(a)]}function
dS(a,b){var
c=ac(a[2]),d=a[1]+b|0;if(c<d){var
e=z(dJ(c*2|0,d));dL(a[2],0,e,0,c);a[2]=e}return}function
aR(a,b){dS(a,1);a3(a[2],a[1],b);a[1]=a[1]+1|0;return}function
B(a,b){var
c=D(b);dS(a,c);aj(b,0,a[2],a[1],c);a[1]=a[1]+c|0;return}function
...
0:var
d=c[1];B(a,hI);c=d;break;case
1:var
e=c[1];B(a,hJ);c=e;break;case
2:var
f=c[1];B(a,hK);c=f;break;case
3:var
g=c[1];B(a,hL);c=g;break;case
4:var
h=c[1];B(a,hM);c=h;break;case
5:var
i=c[1];B(a,hN);c=i;break;case
6:var
j=c[1];B(a,hO);c=j;break;case
7:var
k=c[1];B(a,hP);c=k;break;case
8:var
l=c[2],m=c[1];B(a,hQ);cm(a,m);B(a,hR);c=l;break;case
9:var
n=c[3],o=c[1];B(a,hS);cm(a,o);B(a,hT);c=n;break;case
10:var
p=c[1];B(a,hU);c=p;break;case
11:var
q=c[1];B(a,hV);c=q;break;case
12:var
r=c[1];B(a,hW);c=r;break;case
13:var
s=c[1];B(a,hX);c=s;break;default:var
t=c[1];B(a,hY);c=t}}}function
s(a){if(typeof
a==="number")return 0;switch(a[0]){case
...
12:break c;case
13:break d;case
14:break e}throw g([0,o,h8],1);case
9:var
...
12:break c;case
13:break d;case
14:break e}throw g([0,o,h9],1);case
10:var
A=a[1];if(typeof
b!=="number"&&10===b[0])return[10,t(A,b[1])];throw g([0,o,h_],1);case
11:var
B=a[1];if(typeof
b!=="number")switch(b[0]){case
10:break a;case
11:return[11,t(B,b[1])]}throw g([0,o,h$],1);case
12:var
D=a[1];if(typeof
b!=="number")switch(b[0]){case
10:break a;case
11:break b;case
12:return[12,t(D,b[1])]}throw g([0,o,ia],1);case
13:var
E=a[1];if(typeof
b!=="number")switch(b[0]){case
10:break a;case
11:break b;case
12:break c;case
13:return[13,t(E,b[1])]}throw g([0,o,ib],1);default:var
F=a[1];if(typeof
b!=="number")switch(b[0]){case
10:break a;case
11:break b;case
12:break c;case
13:break d;case
14:return[14,t(F,b[1])]}throw g([0,o,ic],1)}throw g([0,o,h7],1)}if(typeof
...
14:break e;case
8:break f;case
9:break;default:throw g([0,o,hZ],1)}}throw g([0,o,h1],1)}throw g([0,o,h0],1)}throw g([0,o,h6],1)}throw g([0,o,h5],1)}throw g([0,o,h4],1)}throw g([0,o,h3],1)}throw g([0,o,h2],1)}var
x=[c,"CamlinternalFormat.Type_mismatch",at(0)];function
g_(a){return a?g$:ha}var
hg="\\\\",hh="\\'",hi="\\b",hj="\\t",hk="\\n",hl="\\r";function
hn(a){return 25<a+e4>>>0?a:a+gu|0}var
ie=cI,ig="%+d",ih="% d",ii=eY,ij="%+i",ik="% i",il="%x",im="%#x",io="%X",ip="%#X",iq="%o",ir="%#o",is=fz,it="%Ld",iu="%+Ld",iv="% Ld",iw=eO,ix="%+Li",iy="% Li",iz="%Lx",iA="%#Lx",iB="%LX",iC="%#LX",iD="%Lo",iE="%#Lo",iF="%Lu",iG="%ld",iH="%+ld",iI="% ld",iJ=eI,iK="%+li",iL="% li",iM="%lx",iN="%#lx",iO="%lX",iP="%#lX",iQ="%lo",iR="%#lo",iS="%lu",iT="%nd",iU="%+nd",iV="% nd",iW=gA,iX="%+ni",iY="% ni",iZ="%nx",i0="%#nx",i1="%nX",i2="%#nX",i3="%no",i4="%#no",i5="%nu",i6=[0,cH],i$="neg_infinity",ja=fl,jb=cO,jd=[0,v,1558,4],je="Printf: bad conversion %[",jf=[0,v,1626,39],jg=[0,v,1649,31],jh=[0,v,1650,31],ji="Printf: bad conversion %_",jj=fc,jk=f6,jl=fc,jm=f6;function
bD(a,b){if(typeof
...
2:var
ag=a[2],y=bD(a[1],b),e=y[2],ah=y[1];if(typeof
e!=="number"&&1===e[0]){var
z=l(ag,e[1]);return[0,[2,ah,z[1]],z[2]]}throw g(x,1);case
3:var
ai=a[2],A=bD(a[1],b),f=A[2],aj=A[1];if(typeof
f!=="number"&&1===f[0]){var
...
13:if(typeof
b!=="number"&&8===b[0]){var
O=b[1],aI=b[2],aJ=a[3],aK=a[1];if(bv([0,a[2]],[0,O]))throw g(x,1);var
P=l(aJ,aI);return[0,[13,aK,O,P[1]],P[2]]}break;case
14:if(typeof
b!=="number"&&9===b[0]){var
Q=b[1],aL=b[3],aM=a[3],aN=a[2],aO=a[1],aP=[0,q(Q)];if(bv([0,q(aN)],aP))throw g(x,1);var
...
8:if(typeof
c!=="number"&&8===c[0]){var
p=c[1],B=c[2],D=a[2];if(bv([0,a[1]],[0,p]))throw g(x,1);var
r=J(D,b,B);return[0,[8,p,r[1]],r[2]]}break;case
9:if(typeof
c!=="number"&&9===c[0]){var
d=c[2],e=c[1],E=c[3],F=a[3],G=a[2],H=a[1],I=[0,q(e)];if(bv([0,q(H)],I))throw g(x,1);var
K=[0,q(d)];if(bv([0,q(G)],K))throw g(x,1);var
...
N(a,b,c){var
d=D(c),g=0<=b?a:0,f=bz(b);if(f<=d)return c;var
h=2===g?48:32,e=aH(f,h);switch(g){case
0:aj(c,0,e,0,d);break;case
1:aj(c,0,e,f-d|0,d);break;default:a:if(0<d){if(43!==E(c,0)&&45!==E(c,0)&&32!==E(c,0))break a;a3(e,0,E(c,0));aj(c,1,e,(f-d|0)+1|0,d-1|0);break}a:if(1<d&&48===E(c,0)){if(cX!==E(c,1)&&88!==E(c,1))break a;a3(e,1,E(c,1));aj(c,2,e,(f-d|0)+2|0,d-2|0);break}aj(c,0,e,f-d|0,d)}return Q(e)}function
aS(a,b){var
d=bz(a),c=D(b),e=E(b,0);a:{b:{if(58>e){if(32!==e){if(43>e)break a;switch(e-43|0){case
5:c:if(c<(d+2|0)&&1<c){if(cX!==E(b,1)&&88!==E(b,1))break c;var
g=aH(d+2|0,48);a3(g,1,E(b,1));aj(b,2,g,(d-c|0)+4|0,c-2|0);return Q(g)}break b;case
0:case
2:break;case
1:case
3:case
4:break a;default:break b}}if(c>=(d+1|0))break a;var
f=aH(d+1|0,48);a3(f,0,e);aj(b,1,f,(d-c|0)+2|0,c-1|0);return Q(f)}if(71<=e){if(5<e+e4>>>0)break a}else if(65>e)break a}if(c<d){var
h=aH(d,48);aj(b,0,h,d-c|0,c);return Q(h)}}return b}function
id(a){a:{b:c:{var
i=0,A=D(a);for(;;){if(A<=i){var
m=a;break a}var
l=a5(a,i)+gu|0;if(59<l>>>0){if(33<l-61>>>0)break c}else if(2===l)break;i=i+1|0}break b}var
e=ar(a),b=[0,0],p=ac(e)-1|0,v=0;if(p>=0){var
h=v;for(;;){var
f=c_(e,h);b:{c:{d:{if(32<=f){var
...
n=ac(e),o=z(n);aq(e,0,o,0,n);var
s=o}else{var
c=z(b[1]);b[1]=0;var
q=ac(e)-1|0,w=0;if(q>=0){var
g=w;for(;;){var
d=c_(e,g);b:{c:{d:{if(35<=d){if(92!==d){if(bZ<=d)break d;break c}}else{if(32>d){if(14<=d)break d;switch(d){case
...
13:r(c,b[1],92);b[1]++;r(c,b[1],gl);break b;default:break d}}if(34>d)break c}r(c,b[1],92);b[1]++;r(c,b[1],d);break b}r(c,b[1],92);b[1]++;r(c,b[1],48+(d/bU|0)|0);b[1]++;r(c,b[1],48+((d/10|0)%10|0)|0);b[1]++;r(c,b[1],48+(d%10|0)|0);break b}r(c,b[1],d)}b[1]++;var
x=g+1|0;if(q===g)break;g=x}}var
s=c}var
m=Q(s)}var
t=D(m),u=aH(t+2|0,34);b6(m,0,u,1,t);return Q(u)}function
dV(a,b){var
g=bz(b),f=i6[1];switch(a[2]){case
0:var
c=e6;break;case
1:var
c=e7;break;case
...
0:break;case
1:aR(d,43);break;default:aR(d,32)}if(8<=a[2])aR(d,35);aR(d,46);B(d,e+g);aR(d,c);return dT(d)}function
bE(a,b){if(13>a)return b;var
h=[0,0],i=D(b)-1|0,n=0;if(i>=0){var
d=n;for(;;){if(9>=a5(b,d)+fN>>>0)h[1]++;var
...
c=o;for(;;){var
g=a5(b,c);if(9<g+fN>>>0)e(g);else{if(0===f[1]){e(95);f[1]=3}f[1]--;e(g)}var
...
c=is}return bE(a,b9(c,b))}function
...
c=i5}return bE(a,b9(c,b))}function
...
14:var
c=iw;break;default:var
c=iF}return bE(a,mX(c,b))}function
ak(d,b,c){function
f(a){switch(d[1]){case
0:var
e=45;break;case
...
i(a){var
b=mz(c);return 3===b?c<0.?i$:ja:4<=b?jb:a}switch(d[2]){case
5:var
e=dc(dV(d,b),c),a=0,j=D(e);for(;;){if(a===j)var
h=0;else{var
g=E(e,a)-46|0;a:{if(23<g>>>0){if(55===g)break a}else if(21<g-1>>>0)break a;a=a+1|0;continue}var
h=1}var
k=h?e:e+aK;return i(k)}case
6:return f(0);case
7:return Q(dM(hn,ar(f(0))));case
8:return i(f(0));default:return dc(dV(d,b),c)}}function
be(a,b,c,d){var
...
b=hg;break a}if(bZ>a)break b}else{if(32<=a){if(39>a)break b;var
...
d=z(1);r(d,0,a);var
b=Q(d)}var
g=D(b),h=aH(g+2|0,39);b6(b,0,h,1,g);return i(f,[4,e,Q(h)],O)};case
2:return cn(f,e,h[2],h[1],function(a){return a});case
3:return cn(f,e,h[2],h[1],id);case
4:return bF(f,e,h[4],h[2],h[3],i7,h[1]);case
5:return bF(f,e,h[4],h[2],h[3],i8,h[1]);case
6:return bF(f,e,h[4],h[2],h[3],i9,h[1]);case
7:return bF(f,e,h[4],h[2],h[3],i_,h[1]);case
8:var
t=h[4],u=h[3],v=h[2],p=h[1];if(typeof
v==="number"){if(typeof
u==="number")return u?function(a,b){return i(f,[4,e,ak(p,a,b)],t)}:function(a){return i(f,[4,e,ak(p,cl(p),a)],t)};var
_=u[1];return function(a){return i(f,[4,e,ak(p,_,a)],t)}}if(0===v[0]){var
B=v[2],C=v[1];if(typeof
u==="number")return u?function(a,b){return i(f,[4,e,N(C,B,ak(p,a,b))],t)}:function(a){return i(f,[4,e,N(C,B,ak(p,cl(p),a))],t)};var
$=u[1];return function(a){return i(f,[4,e,N(C,B,ak(p,$,a))],t)}}var
E=v[1];if(typeof
u==="number")return u?function(a,b,c){return i(f,[4,e,N(E,a,ak(p,b,c))],t)}:function(a,b){return i(f,[4,e,N(E,a,ak(p,cl(p),b))],t)};var
aa=u[1];return function(a,b){return i(f,[4,e,N(E,a,ak(p,aa,b))],t)};case
9:return cn(f,e,h[2],h[1],g_);case
10:e=[7,e];h=h[1];break;case
11:e=[2,e,h[1]];h=h[2];break;case
12:e=[3,e,h[1]];h=h[2];break;case
13:var
P=h[3],R=h[2],F=dR(16);cm(F,R);var
L=dT(F);return function(a){return i(f,[4,e,L],P)};case
14:var
...
19:throw g([0,o,jd],1);case
20:var
W=h[3],X=[8,e,je];return function(a){return i(f,X,W)};case
21:var
Y=h[2];return function(a){return i(f,[4,e,b9(fz,a)],Y)};case
22:var
...
2:throw g([0,o,jf],1);default:return a<50?k(a+1|0,f,e,j):A(k,[0,f,e,j])}switch(w[0]){case
0:return a<50?k(a+1|0,f,e,j):A(k,[0,f,e,j]);case
1:return a<50?k(a+1|0,f,e,j):A(k,[0,f,e,j]);case
...
i(a,b,c){return dr(be(0,a,b,c))}function
...
13:throw g([0,o,jg],1);default:throw g([0,o,jh],1)}}function
R(a,b,c,d){return dr(cF(0,a,b,c,d))}function
k(a,b,c,d){var
e=[8,c,ji];return a<50?be(a+1|0,b,e,d):A(be,[0,b,e,d])}function
...
g=[4,c,f];return a<50?be(a+1|0,b,g,d):A(be,[0,b,g,d])}function
jc(a,b,c,d,e){return dr(cE(0,a,b,c,d,e))}function
al(a,b){var
c=b;for(;;){if(typeof
c==="number")return;switch(c[0]){case
0:var
f=c[1],g=dU(c[2]);al(a,f);return a8(a,g);case
1:var
d=c[2],e=c[1];if(0===d[0]){var
h=d[1];al(a,e);a8(a,jj);c=h}else{var
i=d[1];al(a,e);a8(a,jk);c=i}break;case
6:var
l=c[2];al(a,c[1]);return m(l,a);case
7:al(a,c[1]);av(a);return;case
8:var
n=c[2];al(a,c[1]);return w(n);case
2:case
4:var
j=c[2];al(a,c[1]);return a8(a,j);default:var
k=c[2];al(a,c[1]);gX(a,k);return}}}function
aA(a,b){var
c=b;for(;;){if(typeof
c==="number")return;switch(c[0]){case
0:var
g=c[1],h=dU(c[2]);aA(a,g);return a_(a,h);case
1:var
e=c[2],f=c[1];if(0===e[0]){var
i=e[1];aA(a,f);a_(a,jl);c=i}else{var
j=e[1];aA(a,f);a_(a,jm);c=j}break;case
6:var
n=c[2];aA(a,c[1]);return a_(a,m(n,0));case
7:c=c[1];break;case
8:var
o=c[2];aA(a,c[1]);return w(o);case
2:case
4:var
k=c[2];aA(a,c[1]);return a_(a,k);default:var
l=c[2];aA(a,c[1]);var
d=a[2];if(a[3]<=d)dQ(a,1);r(a[1],d,l);a[2]=d+1|0;return}}}function
ba(c,b){return i(function(a){al(c,a);return 0},0,b[1])}function
U(a){return i(function(a){var
e=64,c=a9<64?a9:e,d=z(c),b=[0,d,0,c,d];aA(b,a);return dK(b[1],0,b[2])},0,a[1])}var
bM=[0,0],jn=[0,[3,0,0],"%S"],jo=f$,jp=[0,[4,0,0,0,0],cI],jq=e,jr=[0,[11,bS,[2,0,[2,0,0]]],", %s%s"],js=[0,[12,40,[2,0,[2,0,[12,41,0]]]],"(%s%s)"],jt=e,ju=e,jv=[0,[12,40,[2,0,[12,41,0]]],"(%s)"],jw="Out of memory",jx="Stack overflow",jy="Pattern matching failed",jz="Assertion failed",jA="Undefined recursive module",jB="Raised at",jC="Re-raised at",jD="Raised by primitive operation at",jE="Called from",jF=" (inlined)",jG=[0,[2,0,[12,32,[2,0,[11,' in file "',[2,0,[12,34,[2,0,[11,", line ",[4,0,0,0,[11,gx,ma]]]]]]]]]],'%s %s in file "%s"%s, line %d, characters %d-%d'],jH=e,jI=[0,[2,0,[11," unknown location",0]],"%s unknown location"],jJ=[0,[2,0,[12,10,0]],"%s\n"];function
cp(a,b){var
c=a[1+b];if(!(1-(typeof
c==="number"?1:0)))return m(U(jp),c);if(bw(c)===bQ)return m(U(jn),c);if(bw(c)!==253)return jo;var
e=dc("%.12g",c),d=0,g=D(e);for(;;){if(g<=d)return e+aK;var
f=E(e,d);a:{if(48<=f){if(58>f)break a}else if(45===f)break a;return e}d=d+1|0}}function
dW(a,b){if(a.length-1<=b)return jq;var
c=dW(a,b+1|0),d=cp(a,b);return K(U(jr),d,c)}function
bG(a){a:{b:{var
b=bM[1];for(;;){if(!b)break;c:{var
r=b[2],s=b[1];try{var
i=m(s,a)}catch(f){break c}if(i)break b}b=r}var
g=0;break a}var
g=[0,i[1]]}if(g)return g[1];if(a===ch)return jw;if(a===dB)return jx;if(a[1]===dA){var
d=a[2],j=d[3],t=d[2],u=d[1];return cG(U(co),u,t,j,j+5|0,jy)}if(a[1]===o){var
e=a[2],k=e[3],v=e[2],w=e[1];return cG(U(co),w,v,k,k+6|0,jz)}if(a[1]===dD){var
f=a[2],l=f[3],x=f[2],y=f[1];return cG(U(co),y,x,l,l+6|0,jA)}if(0!==bw(a))return a[1];var
h=a.length-1,z=a[1][1];if(2<h>>>0)var
n=dW(a,2),p=cp(a,1),c=K(U(js),p,n);else
switch(h){case
0:var
c=jt;break;case
1:var
c=ju;break;default:var
q=cp(a,1),c=m(U(jv),q)}return z+c}function
cq(a,b){var
f=mA(b),h=f.length-2|0,r=0;if(h>=0){var
d=r;for(;;){var
c=as(f,d)[1+d];let
b=d;var
g=function(a){return a?0===b?jB:jC:0===b?jD:jE};if(0===c[0])var
i=c[5],j=c[4],k=c[3],l=c[6]?jF:jH,n=c[2],o=c[7],p=g(c[1]),e=[0,mb(U(jG),p,o,n,l,k,j,i)];else if(c[1])var
e=0;else
var
q=g(0),e=[0,m(U(jI),q)];if(e){var
s=e[1];m(ba(a,jJ),s)}var
t=d+1|0;if(h===d)break;d=t}}return}function
dX(a){for(;;){var
c=bM[1],d=[0,a,c],e=bM[1]===c?(bM[1]=d,1):0,b=1-e;if(!b)return b}}var
jK=[0,e,"(Cannot print locations:\n bytecode executable program file not found)","(Cannot print locations:\n bytecode executable program file appears to be corrupt)","(Cannot print locations:\n bytecode executable program file has wrong magic number)","(Cannot print locations:\n bytecode executable program file cannot be opened;\n -- too many open files. Try running with OCAMLRUNPARAM=b=2)"].slice(),jL=[0,[11,cW,[2,0,[12,10,0]]],fF],jM=[0],jN="Fatal error: out of memory in uncaught exception handler",jO=[0,[11,cW,[2,0,[12,10,0]]],fF],jP=[0,[11,"Fatal error in uncaught exception handler: exception ",[2,0,[12,10,0]]],"Fatal error in uncaught exception handler: exception %s\n"];cd(gh,function(a,b){try{try{var
h=b?jM:gR(0);try{ci(0)}catch(f){}try{var
f=bG(a);m(ba(W,jL),f);cq(W,h);var
c=nb(0);if(c<0){var
d=bz(c);dG(as(jK,d)[1+d])}var
o=av(W),i=o}catch(f){var
k=ai(f),l=bG(a);m(ba(W,jO),l);cq(W,h);var
n=bG(k);m(ba(W,jP),n);cq(W,gR(0));var
i=av(W)}var
j=i}catch(f){var
e=ai(f);if(e!==ch)throw g(e,0);var
j=dG(jN)}return j}catch(f){return 0}});var
jQ=[c,"Stdlib.Fun.Finally_raised",at(0)];dX(function(a){return a[1]===jQ?[0,"Fun.Finally_raised: "+bG(a[2])]:0});var
hr="String.contains_from / Bytes.contains_from",hu=b3,hv=b3,hw=b3,hx=b3,jR="x",jT=e,jZ="Weak.blit",jY="Weak.check",jX="Weak.get",jW=cM,jV=fM,j4=gk,j6=fL,j7=eH,j8=bP,j9=gp,j_=ez,j$=fm,ka=eF,kb=c2,kc=fU,kd=eS,ke=fK,kf=e2,kg=fX,kh=eX,ki=eB,kj=gt,kk=fy,kl=er,km=fD,kn=bV,ko=fG,kp=eE,kq=gq,kr=gc,ks=fj,kt=bX,ku=cV,kv=fY,kw=fZ,kx=eG,ky=f0,kz=ex,kA=eu,kB=fS,kC=fb,kD=ga,kE=gf,kF=gd,kG=gg,kH=fP,kI=gr,kJ=fw,kK=e8,kL=f1,kM=fJ,kN=fx,kO=fa,kP=gj,kQ=eC,kR=fs,kS=e3,kT=eN,kU=ge,kV=f_,kW=fR,kX=eR,kY=eL,kZ=eo,k0=fq,k1=e_,k2=f7,k3=gB,k4=fI,k5=ey,k6=eP,k7=fu,k8=gy,k9=[0,[11,"EUNKNOWNERR ",[4,0,0,0,0]],"EUNKNOWNERR %d"],j5=[0,[11,"Unix.Unix_error(Unix.",[2,0,[11,bS,[3,0,[11,bS,[3,0,[12,41,0]]]]]]],"Unix.Unix_error(Unix.%s, %S, %S)"],j0=a0,j1=e,j2=e,j3=a0,ld=[0,fC,421,51],lc=[0,fC,410,54],k_="maximal rank exceeded",k$="event already scheduled on a step",la="signal already scheduled on a step",le="OcamlCanvas.V1.Exception.Not_initialized",lf="OcamlCanvas.V1.Exception.File_not_found",lg="OcamlCanvas.V1.Exception.Read_png_failed",lh="OcamlCanvas.V1.Exception.Write_png_failed",li=e$,lj=e,lk="File_not_found",ll=e,lm="Read_png_failed",ln=e,lo="Write_png_failed",lp="transparent_black",lr="transparent_white",ls=eW,lu=fA,lw="blue",lx="cyan",ly="green",lz="lime",lA="orange",lB="pink",lC="red",lU=br(0,0,0),l9=[0,[11,eD,0],eD],l8=[0,0.,0.],l4=[0,0.,109.8],l5=[0,0.,0.],l6=[0,510.,190.],l7=[0,5.,5.],lV=[0,0.,0.],lW=[0,0.,0.],lX=[0,260.,100.],lY=[0,[0,300,e5]],lZ=[0,"Ball"],l0=[0,0.,0.],l1=[0,fT,0.],l2=[0,fT,fH],l3=[0,0.,fH],hc=cj-2|0;function
he(a){throw g(hd,1)}function
hm(a){return 25<a-65>>>0?a:a+32|0}try{var
l$=g0(f2),cr=l$}catch(f){var
d2=ai(f);if(d2!==a7)throw g(d2,0);try{var
l_=g0("CAMLRUNPARAM"),d4=l_}catch(f){var
d3=ai(f);if(d3!==a7)throw g(d3,0);var
d4=jT}var
cr=d4}var
dN=D(cr),ht=0;if(dN<0)var
cs=w(hr);else
try{var
bC=ht;for(;;){if(dN<=bC)throw g(a7,1);if(a5(cr,bC)===82)break;bC=bC+1|0}var
hs=1,cs=hs}catch(f){var
dO=ai(f);if(dO!==a7)throw g(dO,0);var
cs=0}var
aI=[fV,function(a){var
m=ns(0),c=[0,m9(55,0),0],i=0===m.length-1?[0,0]:m,j=i.length-1,b=0;for(;;){as(c[1],b)[1+b]=b;var
w=b+1|0;if(54===b)break;b=w}var
h=[0,jR],k=54+dJ(55,j)|0,s=0;if(k>=0){var
d=s;for(;;){var
f=d%55|0,l=ng(d,j),t=as(i,l)[1+l],n=h[1]+e+t;h[1]=m$(n,0,D(n));var
g=h[1],o=E(g,3)<<24,p=E(g,2)<<16,q=E(g,1)<<8,r=((E(g,0)+q|0)+p|0)+o|0,u=(as(c[1],f)[1+f]^r)&ff;as(c[1],f)[1+f]=u;var
v=d+1|0;if(k===d)break;d=v}}c[2]=0;return c}];function
ct(a){var
b=0<=a?1:0,c=b?a<=hc?1:0:b;if(1-c)w(jV);return nu(a)}function
bI(a){return a.length-3|0}function
cu(a,b,c){var
d=0<=b?1:0,f=d?b<bI(a)?1:0:d,e=1-f;return e?w(c):e}function
aT(a,b,c){cu(a,b,jW);if(c){mF(a,b,c[1]);return}mG(a,b);return}function
aU(a,b){cu(a,b,jX);return mE(a,b)}function
d6(a,b,c,d,e){if(0<=e&&0<=b&&(bI(a)-e|0)>=b&&0<=d&&(bI(c)-e|0)>=d){if(0!==e)mC(a,b,c,d,e);return}return w(jZ)}function
bb(a,b){var
d=bw(b)===c?b:b[1];cd(a,d);return}var
d7=[c,j0,at(0)];bb(j3,[0,d7,0,j2,j1]);dX(function(a){if(a[1]!==d7)return 0;var
...
b=kA}}else
var
g=c[1],b=m(U(k9),g);return[0,mc(U(j5),b,f,e)]});a:b:{var
bH=16,jU=function(a){return mN(10,bU,0,a)};for(;;){if(7<=bH)break b;if(cj<(bH*2|0))break;bH=bH*2|0}break a}if(cs){var
d5=bw(aI);if(bO===d5)var
ae=aI[1];else if(fV===d5){var
hf=aI[1];aI[1]=he;try{var
dI=m(hf,0);ni(aI,dI);var
ae=dI}catch(f){var
dH=ai(f);aI[1]=function(a){throw g(dH,0)};throw g(dH,0)}}else
var
ae=aI;ae[2]=(ae[2]+1|0)%55|0;var
dY=ae[2],dZ=as(ae[1],dY)[1+dY],d0=(ae[2]+24|0)%55|0,jS=(as(ae[1],d0)[1+d0]+(dZ^(dZ>>>25|0)&31)|0)&ff,d1=ae[2];as(ae[1],d1)[1+d1]=jS}function
bJ(a){return[0,ct(a),0]}function
cw(a){a[1]=ct(0);a[2]=0;return 0}function
aV(a,b){return aU(a[1],b)}function
cx(a,b,c){var
d=aU(a[1],c);d6(a[1],b,a[1],c,1);return aT(a[1],b,d)}function
d8(a,b){var
d=bI(a[1]);if(a[2]===d){var
c=ct(2*(a[2]+1|0)|0);d6(a[1],0,c,0,a[2]);a[1]=c}aT(a[1],a[2],[0,b]);a[2]=a[2]+1|0;return}function
d9(a){var
...
f=g<e?d:0<=d_(a,d,e)?e:d,i=0<d_(a,c,f)?1:0;if(!i)return i;cx(a,c,f);c=f}}var
lb=[0,1,bJ(0),0,0];function
cz(a){return[0,0,bJ(11),0,0]}function
d$(a,b){if(b[2]===a)return;b[2]=a;var
d=a[2];d8(d,b);var
c=d[2]-1|0,e=0;for(;;){if(0===c)return e?cy(d,0):e;var
f=(c-1|0)/2|0,g=aV(d,c),h=aV(d,f);if(!g)return;var
i=g[1];if(h){if(0<=dk(i[1],h[1][1]))return e?cy(d,c):e;cx(d,c,f);c=f;e=0}else{cx(d,c,f);c=f;e=1}}}function
cA(a,b){var
f=b[6],d=f[2]-1|0,g=0;if(d>=0){var
c=g;for(;;){var
e=aU(f[1],c);if(e)d$(a,e[1]);var
h=c+1|0;if(d===c)break;c=h}}return 0}function
ea(a){if(a[1])return w(cv);var
b=a;for(;;){var
l=function(a){bB(function(a){return m(a,0)},a[3]);a[3]=0;return},n=function(a){bB(function(a){return m(a,0)},a[4]);a[4]=0;return},o=function(a){a[1]=1;a[2]=bJ(0);return};for(;;){var
c=b[2];a:{b:{for(;;){var
e=c[2];if(0===e)break b;var
k=aV(c,0);if(1<e){var
t=aV(c,e-1|0);aT(c[1],0,t);d9(c);cy(c,0)}else
d9(c);if(k)break}var
g=k;break a}var
...
u=p;bB(function(a){return m(a[5],u)},[0,h,f[1]]);n(b);o(b);b=p}}function
bc(a){return 0}function
bK(a){return 0}function
cB(a){return[0,a,lb,bc,bK,bc,bJ(0)]}cB(bA);function
eb(a){return[0,[0,0],cB(a)]}function
cC(a,b,c){b[1][1]=[0,a];var
d=b[1];c[4]=[0,function(a){d[1]=0;return 0},c[4]];return cA(c,b[2])}function
X(a){var
c=eb(bA);return[0,[0,c],function(a,b){if(!a){var
e=cz(0);c[2][2]=e;cC(b,c,e);return ea(e)}var
d=a[1];if(d[1])w(cv);else if(c[2][2][1])c[2][2]=d;else
w(k$);return cC(b,c,d)}]}function
ec(a,b){if(!b)return 0;var
d=b[1][2],B=a?a[1]:0;if(!B){d[4]=bK;d[5]=bc;return cw(d[6])}var
D=m(d[4],0);d[4]=bK;d[5]=bc;cw(d[6]);var
...
o=ai(f);if(o!==aP)throw g(o,0)}if(c[1]!==f8){var
r=c[6];try{var
l=r[2]-1|0,w=0;if(l>=0){var
h=w;for(;;){var
n=r[1];cu(n,h,jY);if(mD(n,h))throw g(aP,1);var
y=h+1|0;if(l===h)break;h=y}}var
x=1,s=x}catch(f){var
k=ai(f);if(k!==aP)throw g(k,0);var
s=0}if(!(1-s)){var
C=m(c[4],0);c[4]=bK;c[5]=bc;cw(c[6]);f=[0,[0,c,C],f];e=u;continue}}e=u}else{if(!f)return 0;var
v=f[1];f=f[2];t=v[1];e=v[2]}}function
aW(p,b){if(!b)return 0;var
c=b[1],f=c[2],q=f[1]===gm?bA:f[1]<2147483646?f[1]+1|0:w(k_),e=eb(q),h=e[2],d=c[2][6];function
r(a){return[0,c[2],0]}function
s(a){var
b=c[1][1];if(b)return cC(m(p,b[1]),e,a);throw g([0,o,lc],1)}try{var
j=d[2]-1|0,l=0;if(j>=0){var
a=l;for(;;){if(!aU(d[1],a)){aT(d[1],a,[0,h]);throw g(aP,1)}var
n=a+1|0;if(j===a)break;a=n}}d8(d,h)}catch(f){var
i=ai(f);if(i!==aP)throw g(i,0)}if(0!==c[1][1])d$(c[2][2],h);var
k=e[2];k[4]=r;k[5]=s;return[0,e]}bb(li,[c,le,at(0)]);bb(lk,[0,[c,lf,at(0)],lj]);bb(lm,[0,[c,lg,at(0)],ll]);bb(lo,[0,[c,lh,at(0)],ln]);function
ed(a,b){return[0,a[1]+b[1],a[2]+b[2]]}function
bd(a,b){return[0,a[1]*b,a[2]*b]}function
ee(a,b){return[0,a[1]-b[1],a[2]-b[2]]}function
bL(a){return 0<=a?bf<a?bf:a:0}function
aQ(a){return a?a[5]:0}function
ad(a,b,c,d){var
e=aQ(a),f=aQ(d),g=f<=e?e+1|0:f+1|0;return[0,a,b,c,d,g]}function
dP(a,b,c,d){var
g=a?a[5]:0,h=d?d[5]:0;if((h+2|0)<g){if(!a)return w(hv);var
e=a[4],k=a[3],l=a[2],i=a[1],o=aQ(e);if(o<=aQ(i))return ad(i,l,k,ad(e,b,c,d));if(!e)return w(hu);var
p=e[3],q=e[2],r=e[1],s=ad(e[4],b,c,d);return ad(ad(i,l,k,r),q,p,s)}if((g+2|0)>=h){var
z=h<=g?g+1|0:h+1|0;return[0,a,b,c,d,z]}if(!d)return w(hx);var
j=d[4],m=d[3],n=d[2],f=d[1],t=aQ(f);if(t<=aQ(j))return ad(ad(a,b,c,f),n,m,j);if(!f)return w(hw);var
u=f[3],v=f[2],x=f[1],y=ad(f[4],n,m,j);return ad(ad(a,b,c,x),v,u,y)}function
ck(a,b,c){if(!c)return[0,0,a,b,0,1];var
d=c[4],f=c[3],g=c[2],e=c[1],h=no(a,g),k=c[5];if(0===h)return f===b?c:[0,e,a,b,d,k];if(0<=h){var
i=ck(a,b,d);return d===i?c:dP(e,g,f,i)}var
j=ck(a,b,e);return e===j?c:dP(j,g,f,d)}var
ef=[0,0];function
Z(a,b){var
c=ef[1];ef[1]=ck(Q(dM(hm,ar(a))),b,c);return b}var
lq=Z(lp,0);Z(lr,16777215);var
lt=Z(ls,-16777216),lv=Z(lu,-1);Z(lw,-16776961);Z(lx,-16711681);Z(ly,-16744448);Z(lz,-16711936);Z(lA,-23296);Z(lB,-16181);Z(lC,-65536);var
eg=[0,0];cd("Hashtbl.hash",jU);var
eh=X(0),lD=eh[2],lE=eh[1],lF=X(0)[2],lG=X(0)[2],lH=X(0)[2],lI=X(0)[2],ei=X(0),lJ=ei[2],lK=ei[1],ej=X(0),lL=ej[2],lM=ej[1],lN=X(0)[2],ek=X(0),lO=ek[2],lP=ek[1],el=X(0),lQ=el[2],lR=el[1],em=X(0),lS=em[2],lT=em[1],af=[0,0,mH,cB(bA)];af[1]=[0,lU];function
Y(a,b){var
e=af[1];if(!e)throw g([0,o,ld],1);if(K(af[2],e[1],b))return;if(!a){var
d=cz(0);af[3][2]=d;af[1]=[0,b];cA(d,af[3]);return ea(d)}var
c=a[1];if(c[1])w(cv);else if(af[3][2][1])af[3][2]=c;else
w(la);af[1]=[0,b];return cA(c,af[3])}var
cD=[0,0];function
aX(a){cD[1]=[0,a,cD[1]];return}var
_=[0,lX,lW,lV,0];nK(0);var
u=nG(0,0,0,0,0,0,lZ,0,lY,[0,520,e5],0);nL(u,l0);dv(u,l1);dv(u,l2);dv(u,l3);nF(u);nN(u,f9);nP(u);nO(u);aX(aW(function(a){return dw(0)},lK));aX(aW(function(a){var
b=0===a[3][1]?1:0;return b?dw(0):b},lM));aX(aW(function(a){var
b=a[3];_[3]=[0,b[1],b[2]];return 0},lT));aX(aW(function(a){_[4]=1;return 0},lP));aX(aW(function(a){_[4]=0;return 0},lR));aX(aW(function(a){var
p=0.033,y=ee(_[3],_[1]),x=0.99,z=_[4]?bd(y,4.):l8,A=ed(z,l4),B=bd(_[2],x),e=ed(B,bd(A,p)),f=e[2],g=e[1],q=bd(e,p),r=_[1],c=r[2]+q[2],d=r[1]+q[1];if(go<d)var
i=dE(0.-g,0.),h=go;else if(d<bg)var
i=dF(0.-g,0.),h=bg;else
var
i=g,h=d;if(fg<c)var
k=dE(0.-f,0.),j=fg;else if(c<bg)var
k=dF(0.-f,0.),j=bg;else
var
k=f,j=c;var
l=[0,h,j],m=ee(l,_[1]);g6(u,0.);g7(u,lq);g8(u,l5);g5(u,lv);nI(u,l7,l6);g5(u,lt);nD(u);var
n=m[2],o=m[1],b=Math.sqrt(o*o+n*n),s=f9*(Math.exp(b/et)/(1.+Math.exp(b/et)))-5.;g6(u,s);var
t=bL(0),v=bL(0)<<8,w=((bL(0)<<16)+v|0)+t|0;g7(u,(bL(64)<<24)+w|0);g8(u,bd(m,-10.*s/b));nC(u,l,bg,0.,6.283185307179586,0);nH(u,1);_[1]=l;_[2]=[0,i,k];return 0},lE));nM(function(a){switch(a[0]){case
0:break;case
1:var
k=a[1],l=[0,k[1],k[2],0];Y(0,l[2]);lD(0,l);break;case
2:var
f=a[1],m=f[2],n=f[1];if(f[3]){var
o=[0,n,m,0];Y(0,o[2]);lF(0,o)}else{var
p=[0,n,m,0];Y(0,p[2]);lG(0,p)}break;case
3:var
g=a[1],q=[0,g[1],g[2],g[3]];Y(0,q[2]);lH(0,q);break;case
4:var
h=a[1],r=[0,h[1],h[2],h[3]];Y(0,r[2]);lI(0,r);break;case
5:var
s=a[1],t=[0,s[1],s[2],0];Y(0,t[2]);lJ(0,t);break;case
6:var
b=a[1],u=b[5],v=b[4],w=b[3],x=b[2],y=b[1];if(b[6]){var
z=[0,y,x,[0,w,v,u]];Y(0,z[2]);lL(0,z)}else{var
A=[0,y,x,[0,w,v,u]];Y(0,A[2]);lN(0,A)}break;case
7:var
c=a[1],B=c[4],C=c[3],D=c[2],E=c[1];if(c[5]){var
F=[0,E,D,[0,C,B]];Y(0,F[2]);lO(0,F)}else{var
G=[0,E,D,[0,C,B]];Y(0,G[2]);lQ(0,G)}break;default:var
i=a[1],H=[0,i[1],i[2],i[3]];Y(0,H[2]);lS(0,H)}var
j=eg[1];if(!j)return 0;eg[1]=0;var
d=j,e=0;for(;;){if(!d)break;var
I=[0,d[1],e];d=d[2];e=I}return bB(function(a){if(0===a[0]){var
b=a[1];K(a[2],0,a[3]);return ec(0,b)}var
c=a[1];K(a[2],0,a[3]);return ec(0,c)},e)},function(a){cD[1]=0;return ba(hb,l9)});ci(0);return}(globalThis));
